        ...
        <div className="space-y-4">
          {isSpotifyEmailVerificationError ? (
            <div className="rounded-md bg-muted p-4 text-sm">
              <p className="mb-3">
                We just need to verify your Spotify email before you can start
                using TransitionFlow.
              </p>
              <div className="space-y-3">
                <div className="flex items-start gap-2">
                  ...
                  <p>
                    Check your email inbox for a verification message from
                    Spotify
                  </p>
                </div>
                <div className="flex items-start gap-2">
            ...
            <div className="rounded-md bg-muted p-4 text-sm">
              ...
              {errorDetails.errorDescription && (
                <p>
                  <strong>Description:</strong> {errorDetails.errorDescription}
                </p>
              )}
            </div>
          )}

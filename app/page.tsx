...
export default function Home() {
  return (
    <div className="flex flex-col gap-12 pb-8">
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <p className="max-w-[700px] text-muted-foreground md:text-xl">
              Find, share, and rate seamless transitions between your favorite Spotify tracks. Create the ultimate
              flowing playlist experience.
            </p>
      ...
      <section className="container px-4 md:px-6">
        <div className="flex flex-col gap-6">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold tracking-tight md:text-3xl">Featured Transitions</h2>
      ...
      <section className="container px-4 md:px-6">
        <div className="flex flex-col gap-6">
          <h2 className="text-2xl font-bold tracking-tight text-center md:text-3xl">How It Works</h2>
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div className="flex flex-col items-center gap-2 rounded-lg border bg-card p-6 text-center shadow-sm">
              ...
              <p className="text-muted-foreground">
                Browse our database of user-submitted song transitions, filtered by genre, rating, or artist.
              </p>
            </div>
            <div className="flex flex-col items-center gap-2 rounded-lg border bg-card p-6 text-center shadow-sm">
              <div className="rounded-full bg-primary/20 p-3">
              ...
              <p className="text-muted-foreground">
                Vote on transitions and leave feedback to help others find the smoothest song pairings.
              </p>
            </div>
            <div className="flex flex-col items-center gap-2 rounded-lg border bg-card p-6 text-center shadow-sm">
              <div className="rounded-full bg-primary/20 p-3">
              ...
              <p className="text-muted-foreground">
                Submit your favorite song transitions with recommended crossfade times and descriptions.
              </p>
            </div>
          </div>
        </div>
